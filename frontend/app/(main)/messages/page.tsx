...
export default function MessagesPage() {
  ...
  const { conversations, messages, activeConversation, loading, fetchMessages, setActiveConversation } =
    useMessagesStore();
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className={`text-xs font-medium truncate ${isActive ? "text-neon-400" : "text-star-200"}`}>
                        {conv.participants || conv.conversation_id}
                      </span>
                    </div>
                    {lastMsg && (
              ...
              <>
                <div className="p-4 border-b border-neon-600/20 flex items-center gap-2">
                  ...
                  <span className="font-medium text-star-200 text-sm">
                    {activeConv.participants || activeConv.conversation_id}
                  </span>
